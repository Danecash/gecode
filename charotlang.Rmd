...
```{r}
distinct_names <- BB_admin %>% distinct(name_en)
...
ggplot(BB_hex) + 
  ...
  geom_sf(data = BB_boundary, fill = NA, color = "black")
```
...
```{r}
outfile <- glue::glue("Plots/BB_final_2.png")
...
pop_raster <- image_read("Plots/BB_final.png")
